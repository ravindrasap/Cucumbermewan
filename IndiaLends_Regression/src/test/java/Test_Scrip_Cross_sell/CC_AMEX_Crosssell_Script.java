...
import Page_Object_cross_sell.CC_AMEX_Crosssell_Page;
import Utility.Base;

public class CC_AMEX_Crosssell_Script extends Base {
	...
	public void CC_BasicDetailsPage() throws Exception 
	{
		...
		CC_AMEX_Crosssell_Page detailsPage = PageFactory.initElements(driver, CC_AMEX_Crosssell_Page.class);

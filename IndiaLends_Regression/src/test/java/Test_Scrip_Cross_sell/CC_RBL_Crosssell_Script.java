...
import Page_Object_cross_sell.CC_RBL_Crosssell_Page;
import Page_Object_cross_sell.CC_YES_Crosssell_Page;
import Utility.Base;

public class CC_RBL_Crosssell_Script extends Base {
	...
	public void CC_BasicDetailsPage() throws Exception 
	{
		...
		CC_RBL_Crosssell_Page detailsPage = PageFactory.initElements(driver, CC_RBL_Crosssell_Page.class);

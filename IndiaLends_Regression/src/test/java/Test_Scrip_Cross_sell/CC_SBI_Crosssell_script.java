...
import Page_Object_cross_sell.CC_SBI_Crosssell_Page;
import Utility.Base;

public class CC_SBI_Crosssell_script extends Base {
	...
	public void CC_BasicDetailsPage() throws Exception 
	{
		...
		CC_SBI_Crosssell_Page detailsPage = PageFactory.initElements(driver, CC_SBI_Crosssell_Page.class);

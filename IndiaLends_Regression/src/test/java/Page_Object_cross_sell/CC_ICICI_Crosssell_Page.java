...
public class CC_ICICI_Crosssell_Page extends Base{
...
// select the CITI link
	...
	@FindBy(how=How.CSS, using= "#mainNav > div.container-fluid.md-pad10b.sm-pad0b > div.col-xs-12.col-sm-12.col-md-9.pad0 > div.collapse.navbar-collapse.navbar-ex1-collapse.pad10t.sm-pad0t.full-width > ul > li.dropdown.open > ul > li:nth-child(7) > a")
...
*/
	...
	public CC_ICICI_Crosssell_Page(WebDriver driver) {
		this.driver=driver;

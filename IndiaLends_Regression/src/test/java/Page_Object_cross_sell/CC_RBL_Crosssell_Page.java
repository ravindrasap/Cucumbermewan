package Page_Object_cross_sell;
...
public class CC_RBL_Crosssell_Page extends Base{
...
// select the CITI link
	...
	@FindBy(how=How.CSS, using= "#mainNav > div.container-fluid.md-pad10b.sm-pad0b > div.col-xs-12.col-sm-12.col-md-9.pad0 > div.collapse.navbar-collapse.navbar-ex1-collapse.pad10t.sm-pad0t.full-width > ul > li.dropdown.open > ul > li:nth-child(4) > a")
	private WebElement clickrbllender;	
...
*/
	...
	public CC_RBL_Crosssell_Page(WebDriver driver) {
		this.driver=driver;
	...
	public void enterBasicdetailsToCCEligibility() throws Exception 
	{
	      ...
	      public void contact_CCDetails() throws Exception {
			...
			try {		
				...
				//	Thread.sleep(1000);
					...
					// select the ICICI relationship =============
					WebElement icicreltion=driver.findElement(By.cssSelector("#li_icici_relationship_type"));
					Select Relationicici=new Select(icicreltion);
					Relationicici.selectByIndex(1);
					driver.findElement(By.xpath("//*[@id=\"salary_slip_yes\"]")).click();
					
					// select the address proof ==============
					
					WebElement addressp=driver.findElement(By.cssSelector("#li_add_proof"));
					Select adressp=new Select(addressp);
					adressp.selectByIndex(1);
					Thread.sleep(1000);
					
					// select the address proof id ====================
					
					WebElement addresid=driver.findElement(By.cssSelector("#li_id_proof > select"));
					Select adresid=new Select(addresid);
					adresid.selectByIndex(1);
		...
		public void Mobileotp() throws Exception {
		     ...
		     try {
		    	...
		    	// String otpURL =" https://staging.indialends.com/internal/a/get_otp_mail_verify_api.ashx?mobileno=";

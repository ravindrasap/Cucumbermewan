...
public class CC_AMEX_Crosssell_Page extends Base{
...
// select the SBI link
	...
	@FindBy(how=How.XPATH, using= "//*[@id=\"mainNav\"]/div[6]/div[1]/div[2]/ul/li[2]/ul/li[3]/a")
	private WebElement clicAMEXClink;
...
*/
	...
	public CC_AMEX_Crosssell_Page(WebDriver driver) {
		this.driver=driver;
	      ...
	      public void contact_CCDetails() throws Exception {
			...
			try {		
				...
				landlineNo.sendKeys("27123468");
			   	...
			   	driver.findElement(By.cssSelector("#li_amex_card_number")).sendKeys("4534635575464767");
	      ...
	      public void contact_CCADDetails() throws Exception {
	    	  ...
	    	  try {		
				   ...
				   driver.findElement(By.xpath("//*[@id=\"myCarouselMobile\"]/ol/li[1]")).click();
					...
					driver.findElement(By.xpath("//*[@id=\"div_sbi_relationship\"]/label[1]")).click();
					
					driver.findElement(By.xpath("//*[@id=\"li_sbi_relation_type\"]")).click();
					WebElement Sbirelation=driver.findElement(By.cssSelector("#li_sbi_relation_type"));
					Select relationType=new Select(Sbirelation);
					relationType.selectByIndex(1);
					
					driver.findElement(By.xpath("//*[@id=\"account\"]")).sendKeys("6323525245235235");

...
public class PL_Page extends Base{
  ...
  // Terms&Cond text
	//@FindBy(how=How.XPATH, using="//*[@id=\"mobile_verification\"]/div/div/div[2]/label/div[1]")
	...
	/*	WebDriverWait wait = new WebDriverWait(driver, 20);
		...
		//	 System.out.println("OTpresend link is coming "); 
			// String ResendOTP = driver.findElement(By.xpath("OTpresend")).getText();
			 if (ResendOTP.contains("Resend OTP"))
			 {
			 ...
			 }else
			 {
				 ...
				 if (GetOTPcall.contains("Get OTP through Call"))
				 {
			...
			wait1.until(ExpectedConditions.visibilityOf(otptake));

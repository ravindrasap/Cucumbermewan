	...
	public class CC_CRM_RBLLender_Page  extends Base {
		...
		@FindBy(how = How.XPATH, using = "//*[@id=\"mainNav\"]/div[6]/div[1]/div[2]/ul/li[2]/ul/li[4]/a")
		...
		public CC_CRM_RBLLender_Page(WebDriver driver) {
			this.driver = driver;
		...
		public void enterBasicdetailsToCheckLoanEligibility() throws Exception {
			...
			try {	
				...
				driver.findElement(By.cssSelector("#li_email_id")).sendKeys("testuser@test.com");
		...
		public String CRM_Login(String mobileno) throws InterruptedException {
			...
			//	for(int i=0;i<=size;i++) {
					...
					driver.findElement(By.cssSelector("#li_res_street")).sendKeys("Street");
					...
					driver.findElement(By.cssSelector("#li_off_house_no")).sendKeys("Office house no");
					driver.findElement(By.cssSelector("#li_off_street")).sendKeys("Office Street");
					driver.findElement(By.cssSelector("#li_off_landmark")).sendKeys("Office landmark");
					driver.findElement(By.cssSelector("#li_off_area")).sendKeys("Office area");

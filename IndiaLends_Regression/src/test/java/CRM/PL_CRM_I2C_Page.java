...
import CRM.GetDBValue;
import CRM.PL_CRM_Login;
import Utility.Base;

public class PL_CRM_I2C_Page {
	...
	//@Test
	public void enterBasicdetailsToCheckLoanITCEligibility() throws Exception {
	//public void plIncomplete() throws Exception  {
     ...
     //  driver.findElement(By.xpath("//*[@id=\"mainNav\"]/div[6]/div[1]/div[2]/ul/li[1]/a")).click();
		driver.get("https://indialends.com/personal-loan");
		driver.manage().window().maximize();

		driver.findElement(By.cssSelector("#li_display_name")).sendKeys("Test User");
		driver.findElement(By.cssSelector("#email")).sendKeys("testuser@qgmail.com");
		...
		driver.findElement(By.cssSelector("#btn_mobile_verify")).click();

		Thread.sleep(3000);

		System.out.println("Sucessfully submitted OTP");
		         
		GetDBValue dbValue = new GetDBValue();
		String key = dbValue.fetchDbValue(mobileno);
		Thread.sleep(2000);
		PL_CRM_Login login = new PL_CRM_Login();
		
		login.verifyLogin(key);
	//	driver.close();
	//	driver.quit();
	}
	...
	//	public class PL_CRM_Login {
		...
		//	WebDriver driver1;
			...
			public void verifyLogin(String encrypt) throws Exception {
				p2URL = "https://crm.indialends.com/admin/nbfc_customer_contact_v2.aspx?admin_id="+encrypt;
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\ravindrakumar\\eclipse-workspace\\IndiaLends_Regression\\driver\\chromedriver.exe");

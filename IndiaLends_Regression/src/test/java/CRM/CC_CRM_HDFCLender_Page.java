...
public class CC_CRM_HDFCLender_Page extends Base {
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"mainNav\"]/div[6]/div[1]/div[2]/ul/li[2]/ul/li[7]/a")
	private WebElement clickHDFClender;
	// =============== New User journey ==============================
	...
	public CC_CRM_HDFCLender_Page(WebDriver driver) {
		this.driver = driver;
	...
	//	for (int i = 0; i <= size; i++) {
			...
			WebElement Recivesalary = driver.findElement(By.cssSelector("#li_salary_mode"));
			Select salarytype = new Select(Recivesalary);
			salarytype.selectByIndex(8);
			...
			driver.findElement(By.xpath("//*[@id=\"div_lst_three_slry_slip\"]/label/span[1]")).click();

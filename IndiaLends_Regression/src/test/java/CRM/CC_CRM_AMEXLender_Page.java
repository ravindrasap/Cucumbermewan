...
public class CC_CRM_AMEXLender_Page extends Base {
   ...
   protected WebDriver driver;
	...
	private WebElement clicAMEXlender;
	// =============== New User journey ==============================
	...
	// ======================= CRM login ==============
		...
		public CC_CRM_AMEXLender_Page(WebDriver driver) {
			this.driver = driver;
	...
	public String CRM_Login(String mobileno) throws InterruptedException {
		...
		//for (int i = 0; i <= size; i++) {
			...
			driver.findElement(By.cssSelector("#li_off_phone")).sendKeys("9560229331");

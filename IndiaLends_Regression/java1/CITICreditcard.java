...
public class CITICreditcard {
	...
	public void verify_PL_Form() throws Exception {
		...
		//Basic Details
		driver.findElement(By.cssSelector("#li_first_name")).sendKeys("test MEENAs");	
	...
	public void check_Eligibility() throws Exception {
		...
		driver.findElement(By.cssSelector("#li_pan_number")).sendKeys("HDFPJ1273C");

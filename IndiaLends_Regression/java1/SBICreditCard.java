...
public class SBICreditCard {
	...
	//String otpURL= "https://globallends.com/internal/a/get_otp_mail_verify_api.ashx?mobileno=";
	...
	//	driver.navigate().to("http://staging.indialends.com/credit-cards/");
	...
	public void check_Eligibility() throws Exception {
		...
		driver.findElement(By.cssSelector("#li_pan_number")).sendKeys("AWAPM9174J");
	...
	public void general_Information() throws Exception {
		...
		Thread.sleep(2000);
		 ...
		 List<WebElement> offer = driver.findElements(By.tagName("h5"));
	        ...
	        for(int i=0; i<offer.size();i++){
	        	String cardname =offer.get(i).getText();
	        	//Assert.assertEquals(cardname,"SBI Card ELITE");
	        	String expected = "SBI Card ELITE";
	        	
	        	if(expected.equals(cardname)){
	                System.out.println("Pass");
	                driver.findElement(By.cssSelector("#btn_105")).click();
	            }
	                else {
	   ...
	   // driver.findElement(By.cssSelector("#Married")).click();
	  //  driver.findElement(By.cssSelector("#Graduate")).click();
		...
		//Office address
		driver.findElement(By.cssSelector("#li_off_door_no")).sendKeys("10 -dssd");
	...
	public void check_Eligibility() throws Exception {
		...
		driver.findElement(By.cssSelector("#radio-8")).click();
		driver.findElement(By.cssSelector("#li_off_pin")).sendKeys("110040");
		driver.findElement(By.cssSelector("#li_pan_number")).sendKeys("ZXAPM9174N");
	...
	public void general_Information() throws Exception {
		...
		Thread.sleep(2000);
		 ...
		 /*List<WebElement> offer = driver.findElements(By.tagName("h5"));
	        ...
	        Thread.sleep(3000);*/
	    driver.findElement(By.cssSelector("#btn_101")).click();
	/*	driver.findElement(By.cssSelector("#priority_cards > div:nth-child(1) > div.panel-body > div.col-md-8.pad0 > div.col-xs-5.col-sm-6.pad0l.text-right.pad10t.md-pad20t.btn-section > span")).click();
	...
	public void contact_Details() throws Exception {
		...
		driver.findElement(By.cssSelector("#landine_number")).sendKeys("26826826");*/
		driver.findElement(By.cssSelector("#sbi_relation_no")).click();
		driver.findElement(By.cssSelector("#li_designation")).sendKeys("Software Developer"); 
		driver.findElement(By.cssSelector("#bankwise_controls_submit")).click();
	}

...
//	String otpURL="https://v.indialends.com/test/get_otp_user_registration_encrypt.ashx?type=json&mobileno=";
	...
	public void set_UP()
	{
		...
		driver.navigate().to("https://staging.indialends.com/credit-cards/");
	...
	public void check_Eligibility() throws Exception {
		...
		driver.findElement(By.cssSelector("#li_pan_number")).sendKeys("HDFPC1181C");
	...
	public void general_Information() throws Exception {
		...
		Thread.sleep(2000);
		 ...
		 List<WebElement> offer = driver.findElements(By.tagName("h5"));
	        ...
	        Thread.sleep(3000);
	        driver.findElement(By.cssSelector("#btn_701")).click();
	...
	//	driver.findElement(By.cssSelector("#landine_code")).sendKeys("0124");
		
		driver.findElement(By.cssSelector("#landine_number")).sendKeys("26826827");
		WebElement RELATIONSHIP =driver.findElement(By.cssSelector("#li_icici_relationship_type"));
		Select REL=new Select(RELATIONSHIP);
		REL.selectByVisibleText("Salary");
		//REL.selectByVisibleText("No Relationship");
		driver.findElement(By.cssSelector("#salary_slip_yes")).click();
		WebElement addProof =driver.findElement(By.cssSelector("#li_add_proof"));
		Select addprf=new Select(addProof);
		addprf.selectByValue("Passport");
		WebElement idProof =driver.findElement(By.cssSelector("#li_id_proof > select"));
		Select idprf=new Select(idProof);
		idprf.selectByValue("Passport");
